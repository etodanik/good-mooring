...
static void HandleParsedInput(SwitchController* con, TFInputPortIndex portIndex, SCParsedInput& curr)
{
    UNREF_PARAM(con);
...
static void HIDParseSwitchControllerInputFull(SwitchController* con, SCPacketIn_InputFull* currRep, TFInputPortIndex portIndex)
{
...
static void HIDParseSwitchControllerInputSimple(SwitchController* con, SCPacketIn_InputSimple* currRep, TFInputPortIndex portIndex)
{
