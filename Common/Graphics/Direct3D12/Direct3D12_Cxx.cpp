...
#include "../../../Common/Graphics/ThirdParty/OpenSource/DirectXShaderCompiler/inc/dxcapi.h"
...
#include <pix3.h>
#else
#include "../../../Common/Graphics/ThirdParty/OpenSource/winpixeventruntime/Include/WinPixEventRuntime/pix3.h"
#endif
#endif
#if defined(FORGE_PROFILE)
#undef PROFILE_BUILD
