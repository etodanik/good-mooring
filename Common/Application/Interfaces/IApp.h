...
public:
    ...
    virtual bool Load(TFReloadDesc* pReloadDesc) = 0;
    virtual void Unload(TFReloadDesc* pReloadDesc) = 0;
    ...
    struct Settings
    {
        ...
        uint64_t mFrames = 0;
        /// Defines the number of frames in flight + 1
        uint32_t mFrameMaxCount = 2;
        /// The index of the current frame to draw
    ...
    // App input bindings
    TFInputEnum CUSTOM_MOVE_X = {};
    TFInputEnum CUSTOM_MOVE_Y = {};
    TFInputEnum CUSTOM_MOVE_UP = {};
    TFInputEnum CUSTOM_LOOK_X = {};
    TFInputEnum CUSTOM_LOOK_Y = {};
    TFInputEnum CUSTOM_RESET_VIEW = {};
    TFInputEnum CUSTOM_TOGGLE_FULLSCREEN = {};
    TFInputEnum CUSTOM_DUMP_PROFILE = {};
    TFInputEnum CUSTOM_EXIT = {};
    TFInputEnum CUSTOM_TOGGLE_INTERFACE = {};
    TFInputEnum CUSTOM_PT_X = {};
    TFInputEnum CUSTOM_PT_Y = {};
    TFInputEnum CUSTOM_PT_DOWN = {};
...
#define DEFINE_APPLICATION_MAIN(appClass)                    \
    ...
    {                                                        \
        ...
        IApp::argv = nullptr;                                \
        static appClass app = {};                            \
        return WindowsMain(0, nullptr, &app);                \
    }
