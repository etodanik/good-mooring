...
void Rig::Initialize(const TFResourceDirectory resourceDir, const char* fileName)
{
    // Reading skeleton.
...
bool Rig::LoadSkeleton(const TFResourceDirectory resourceDir, const char* fileName)
{
    TFFileStream file = {};
