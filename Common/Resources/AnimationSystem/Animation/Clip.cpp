...
void Clip::Initialize(const TFResourceDirectory resourceDir, const char* fileName, Rig* rig)
{
    UNREF_PARAM(rig);
...
bool Clip::LoadClip(const TFResourceDirectory resourceDir, const char* fileName)
{
    TFFileStream file = {};
    ...
    TFFileStream memStream = {};
    fsOpenStreamFromMemory(data, size, TF_FM_READ, true, &memStream);
