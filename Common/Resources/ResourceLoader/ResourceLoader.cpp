...
{
    MTRACY_ZONE("addResource");
    addResource_Buffer(pBufferDesc, token);
}

void addResource(TFTextureLoadDesc* pTextureDesc, TFSyncToken* token)
{
    MTRACY_ZONE("addResource");
    addResource_Texture(pTextureDesc, token);
}

void addResource(TFGeometryLoadDesc* pDesc, TFSyncToken* token)
{
    MTRACY_ZONE("addResource");
    addResource_Geometry(pDesc, token);
}
...
void addShader(TFRenderer* pRenderer, const TFShaderLoadDesc* pDesc, TFShader** ppShader)
{
    ...
    MTRACY_TEXT(pDesc->mComp.pFileName);
    MTRACY_TEXT(pDesc->mVert.pFileName);
    MTRACY_TEXT(pDesc->mFrag.pFileName);
