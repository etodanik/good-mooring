...
#define LoadByte2(BUFF, ADDR) { (uint)(BUFF)[(ADDR)], (uint)(BUFF)[(ADDR) + 1] }
#define LoadByte3(BUFF, ADDR) { (uint)(BUFF)[(ADDR)], (uint)(BUFF)[(ADDR) + 1], (uint)(BUFF)[(ADDR) + 2] }
#define LoadByte4(BUFF, ADDR) { (uint)(BUFF)[(ADDR)], (uint)(BUFF)[(ADDR) + 1], (uint)(BUFF)[(ADDR) + 2], (uint)(BUFF)[(ADDR) + 3] }
