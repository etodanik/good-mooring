...
#define d2x2           double2x2
#define d2x3           double3x2
#define d2x4           double4x2
#define d3x2           double2x3
#define d3x3           double3x3
#define d3x4           double4x3
#define d4x2           double2x4
#define d4x3           double3x4
#define d4x4           double4x4

#define quat           float4
#define float3Aligned  float3
#define double3Aligned double3
#define int3Aligned    int3
#define uint3Aligned   uint3
...
inline void setElem(inout f2x2 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout f2x3 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout f2x4 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout f3x2 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout f3x3 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout f3x4 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout f4x2 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout f4x3 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout f4x4 M, int i, int j, float val) { M[j][i] = val; }
inline void setElem(inout d2x2 M, int i, int j, double val) { M[j][i] = val; }
inline void setElem(inout d2x3 M, int i, int j, double val) { M[j][i] = val; }
inline void setElem(inout d2x4 M, int i, int j, double val) { M[j][i] = val; }
inline void setElem(inout d3x2 M, int i, int j, double val) { M[j][i] = val; }
inline void setElem(inout d3x3 M, int i, int j, double val) { M[j][i] = val; }
inline void setElem(inout d3x4 M, int i, int j, double val) { M[j][i] = val; }
inline void setElem(inout d4x2 M, int i, int j, double val) { M[j][i] = val; }
inline void setElem(inout d4x3 M, int i, int j, double val) { M[j][i] = val; }
inline void setElem(inout d4x4 M, int i, int j, double val) { M[j][i] = val; }

inline float  getElem(f2x2 M, int i, int j) { return M[j][i]; }
inline float  getElem(f2x3 M, int i, int j) { return M[j][i]; }
inline float  getElem(f2x4 M, int i, int j) { return M[j][i]; }
inline float  getElem(f3x2 M, int i, int j) { return M[j][i]; }
inline float  getElem(f3x3 M, int i, int j) { return M[j][i]; }
inline float  getElem(f3x4 M, int i, int j) { return M[j][i]; }
inline float  getElem(f4x2 M, int i, int j) { return M[j][i]; }
inline float  getElem(f4x3 M, int i, int j) { return M[j][i]; }
inline float  getElem(f4x4 M, int i, int j) { return M[j][i]; }
inline double getElem(d2x2 M, int i, int j) { return M[j][i]; }
inline double getElem(d2x3 M, int i, int j) { return M[j][i]; }
inline double getElem(d2x4 M, int i, int j) { return M[j][i]; }
inline double getElem(d3x2 M, int i, int j) { return M[j][i]; }
inline double getElem(d3x3 M, int i, int j) { return M[j][i]; }
inline double getElem(d3x4 M, int i, int j) { return M[j][i]; }
inline double getElem(d4x2 M, int i, int j) { return M[j][i]; }
inline double getElem(d4x3 M, int i, int j) { return M[j][i]; }
inline double getElem(d4x4 M, int i, int j) { return M[j][i]; }
...
inline double4 getCol(in d4x4 M, const uint i) { return double4(M[0][i], M[1][i], M[2][i], M[3][i]); }
inline double3 getCol(in d4x3 M, const uint i) { return double3(M[0][i], M[1][i], M[2][i]); }
inline double2 getCol(in d4x2 M, const uint i) { return double2(M[0][i], M[1][i]); }

inline double4 getCol(in d3x4 M, const uint i) { return double4(M[0][i], M[1][i], M[2][i], M[3][i]); }
inline double3 getCol(in d3x3 M, const uint i) { return double3(M[0][i], M[1][i], M[2][i]); }
inline double2 getCol(in d3x2 M, const uint i) { return double2(M[0][i], M[1][i]); }

inline double4 getCol(in d2x4 M, const uint i) { return double4(M[0][i], M[1][i], M[2][i], M[3][i]); }
inline double3 getCol(in d2x3 M, const uint i) { return double3(M[0][i], M[1][i], M[2][i]); }
inline double2 getCol(in d2x2 M, const uint i) { return double2(M[0][i], M[1][i]); }
...
inline d4x4 setCol(inout d4x4 M, in double4 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    M[2][i] = col[2];
...
inline d4x3 setCol(inout d4x3 M, in double3 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    M[2][i] = col[2];
...
inline d4x2 setCol(inout d4x2 M, in double2 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    return M;
...
inline d3x4 setCol(inout d3x4 M, in double4 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    M[2][i] = col[2];
...
inline d3x3 setCol(inout d3x3 M, in double3 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    M[2][i] = col[2];
...
inline d3x2 setCol(inout d3x2 M, in double2 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    return M;
...
inline d2x4 setCol(inout d2x4 M, in double4 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    M[2][i] = col[2];
...
inline d2x3 setCol(inout d2x3 M, in double3 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    M[2][i] = col[2];
...
inline d2x2 setCol(inout d2x2 M, in double2 col, const uint i)
{
    M[0][i] = col[0];
    M[1][i] = col[1];
    return M;
...
d4x4 setRow(inout d4x4 M, in double4 row, const uint i)
{
    M[i] = row;
    return M;
}
d4x3 setRow(inout d4x3 M, in double4 row, const uint i)
{
    M[i] = row;
    return M;
}
d4x2 setRow(inout d4x2 M, in double4 row, const uint i)
{
    M[i] = row;
    return M;
}

d3x4 setRow(inout d3x4 M, in double3 row, const uint i)
{
    M[i] = row;
    return M;
}
d3x3 setRow(inout d3x3 M, in double3 row, const uint i)
{
    M[i] = row;
    return M;
}
d3x2 setRow(inout d3x2 M, in double3 row, const uint i)
{
    M[i] = row;
    return M;
}

d2x4 setRow(inout d2x4 M, in double2 row, const uint i)
{
    M[i] = row;
    return M;
}
d2x3 setRow(inout d2x3 M, in double2 row, const uint i)
{
    M[i] = row;
    return M;
}
d2x2 setRow(inout d2x2 M, in double2 row, const uint i)
{
    M[i] = row;
    return M;
}
...
#if defined(DIRECT3D12) || defined(HOLOLENS2)
...
#else
bool2 And(const bool2 a, const bool2 b) { return and(a, b); }
#endif
...
#define AtomicOr(DEST, VALUE, ORIGINAL_VALUE)  InterlockedOr(DEST, VALUE, ORIGINAL_VALUE)

#define AtomicAnd(DEST, VALUE, ORIGINAL_VALUE) InterlockedAnd(DEST, VALUE, ORIGINAL_VALUE)

#define AtomicXor(DEST, VALUE, ORIGINAL_VALUE) InterlockedXor(DEST, VALUE, ORIGINAL_VALUE)
#endif
...
#if defined(DIRECT3D12) || defined(ORBIS) || defined(PROSPERO) || defined(HOLOLENS2)
...
#define _DECL_SampleLvlTex2DArray(TYPE) \
    inline TYPE SampleLvlTex2DArray(Texture2DArray<TYPE> tex, SamplerState smp, float3 p, float l) { return tex.SampleLevel(smp, p, l); }
...
#define _DECL_LoadTex3D(TYPE)                                                                                             \
    ...
    inline TYPE LoadRWTex2DArray(RWTexture2DArray<TYPE> tex, int3 p) { return tex[p]; }
...
// #define SampleGradTex2DArray(NAME, SAMPLER, COORD, DX, DY) (NAME).SampleGrad( (SAMPLER), (COORD), (DX), (DY) )
#define _DECL_SampleGradTex2DArray(TYPE)                                                                         \
    inline TYPE SampleGradTex2DArray(Texture2DArray<TYPE> tex, SamplerState smp, float3 p, float2 dx, float2 dy) \
    {                                                                                                            \
        return tex.SampleGrad(smp, p, dx, dy);                                                                   \
    }
_DECL_FLOAT_TYPES(_DECL_SampleGradTex2DArray)

#define GatherRedTex2D(NAME, SAMPLER, COORD)               (NAME).GatherRed((SAMPLER), (COORD))
#define GatherRedTex3D(NAME, SAMPLER, COORD)               (NAME).GatherRed((SAMPLER), (COORD))
...
#define _DECL_SampleTexCubeArray(TYPE) \
    inline TYPE SampleTexCubeArray(TextureCubeArray<TYPE> tex, SamplerState smp, float4 p) { return tex.Sample(smp, p); }
...
#define _DECL_SampleBiasTex2D(TYPE) \
    inline TYPE SampleBiasTex2D(Texture2D<TYPE> tex, SamplerState smp, float2 p, float b) { return tex.SampleBias(smp, p, b); }
        _DECL_FLOAT_TYPES(_DECL_SampleBiasTex2D)
...
#define _DECL_WriteRasterizerOrderedTexture2D(TYPE) \
    inline void Write2D(RasterizerOrderedTexture2D<TYPE> tex, int2 p, TYPE val) { tex[p] = val; }
                _DECL_TYPES(_DECL_WriteRasterizerOrderedTexture2D)
                    ...
                    void Write2DArray(RWTexture2DArray<float2> dst, int2 coord, int array, uint2 val)
{
    dst[int3(coord, array)] = val;
}
void Write2DArray(RWTexture2DArray<float3> dst, int2 coord, int array, uint3 val) { dst[int3(coord, array)] = val; }
void Write2DArray(RWTexture2DArray<float4> dst, int2 coord, int array, uint4 val) { dst[int3(coord, array)] = val; }
...
#define _DECL_AtomicMin2D(TYPE) \
    inline void AtomicMin2D(RWTexture2D<TYPE> tex, int2 p, TYPE val, out TYPE original_val) { InterlockedMin(tex[p], val, original_val); }
        _DECL_AtomicMin2D(uint)

#define _DECL_AtomicMax2D(TYPE) \
    inline void AtomicMax2D(RWTexture2D<TYPE> tex, int2 p, TYPE val, out TYPE original_val) { InterlockedMax(tex[p], val, original_val); }
...
#define _DECL_GetDimensionsTex2DArray(TYPE)                  \
    inline int2 GetDimensions(Texture2DArray<TYPE> t, int _) \
    {                                                        \
        uint3 d;                                             \
        t.GetDimensions(d.x, d.y, d.z);                      \
        return int2(d.xy);                                   \
    }                                                        \
    inline int2 GetDimensions(Texture2DArray<TYPE> t, SamplerState smp) { return GetDimensions(t, NO_SAMPLER); }
_DECL_FLOAT_TYPES(_DECL_GetDimensionsTex2DArray)
...
#define GetDimensionsMSArray(tex, dim)         \
    int2 dim;                                  \
    {                                          \
        uint4 d;                               \
        tex.GetDimensions(d.x, d.y, d.z, d.w); \
        dim = int2(d.xy);                      \
    }
...
#define Depth2DArray                              Tex2DArray
#define Depth2DArrayMS                            Tex2DArrayMS
...
#if defined(DIRECT3D12) || defined(HOLOLENS2)
#define TF_ADDRESS_MODE_REPEAT          TEXTURE_ADDRESS_MODE_WRAP
#define TF_ADDRESS_MODE_MIRROR          TEXTURE_ADDRESS_MODE_MIRROR
#define TF_ADDRESS_MODE_CLAMP_TO_EDGE   TEXTURE_ADDRESS_MODE_CLAMP
#define TF_ADDRESS_MODE_CLAMP_TO_BORDER TEXTURE_ADDRESS_MODE_BORDER

#define TF_CMP_NEVER                    COMPARISON_FUNC_NONE
#define TF_CMP_LESS                     COMPARISON_FUNC_LESS
#define TF_CMP_EQUAL                    COMPARISON_FUNC_EQUAL
#define TF_CMP_LEQUAL                   COMPARISON_FUNC_LESS_EQUAL
#define TF_CMP_GREATER                  COMPARISON_FUNC_GREATER
#define TF_CMP_NOTEQUAL                 COMPARISON_FUNC_NOT_EQUAL
#define TF_CMP_GEQUAL                   COMPARISON_FUNC_GREATER_EQUAL
#define TF_CMP_ALWAYS                   COMPARISON_FUNC_ALWAYS
#endif
