...
bool bunyArLibCreate(TFResourceDirectory rd, const char* dstPath, const struct BunyArLibCreateDesc* desc, bool skipPreProcess);
...
bool bunyArLibExtract(struct TFIFileSystem* archiveFs, TFResourceDirectory rd, const char* dstPath,
