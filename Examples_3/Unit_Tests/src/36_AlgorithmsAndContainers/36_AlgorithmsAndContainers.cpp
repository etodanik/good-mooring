...
public:
    ...
    void Unload(TFReloadDesc* pReloadDesc) { UNREF_PARAM(pReloadDesc); }
...
int testMatrices()
{
    ...
    // double
    {
        Matrix4d viewLHMatrix = Matrix4d::lookAtLH(Vector3d(0.0f, 0.0f, 0.0f), Vector3d(0.0f, 0.0f, 100.0f), Vector3d(0.0f, 1.0f, 0.0f));
        Matrix4d viewRHMatrix = Matrix4d::lookAtRH(Vector3d(0.0f, 0.0f, 0.0f), Vector3d(0.0f, 0.0f, -100.0f), Vector3d(0.0f, 1.0f, 0.0f));
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            if (pLH.x != pRH.x || pLH.y != pRH.y || pLH.z != pRH.z || pLH.w != pRH.w)
                return 1;
