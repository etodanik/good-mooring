...
typedef struct TriangleFilteringPassDesc
{
    ...
    TFDescriptorSet* pDescriptorSetTriangleFilteringPerDraw;
...
FORGE_RENDERER_API FilteringStats cmdVisibilityBufferTriangleFilteringPass(VisibilityBuffer* pVisibilityBuffer, TFCmd* pCmd,
