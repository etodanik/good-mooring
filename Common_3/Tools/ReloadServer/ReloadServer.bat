...
ELSE (
    if "%cwd:~-14%" == "ParticleEditor" (
        ..\..\..\..\..\..\The-Forge\Tools\python-3.6.0-embed-amd64\python.exe ..\..\..\..\..\..\The-Forge\Common_3\Tools\ReloadServer\ReloadServer.py --kill
        ..\..\..\..\..\..\The-Forge\Tools\python-3.6.0-embed-amd64\python.exe ..\..\..\..\..\..\The-Forge\Common_3\Tools\ReloadServer\ReloadServer.py %*
    ) ELSE (
