...
extern "C" {
    ...
    /*! \brief open TIFF file for reading
      ...
      */
    TINYTIFF_EXPORT TinyTIFFReaderFile* TinyTIFFReader_open(TFResourceDirectory resourceDir, const char* filename);
    ...
    /** \brief returns the version number of TinyTIFFReader
      * \ingroup tinytiffreader_C
      */
TINYTIFF_EXPORT const char* TinyTIFFReader_getVersion(void);
