...
inline TYPE SampleLvlTex2DArray(Texture2DArray<TYPE> tex, SamplerState smp, float3 p, float l) \
...
void Write2DArray(RWTexture2DArray<float2> dst, int2 coord, int array, uint2 val) { dst[int3(coord, array)] = val; }
