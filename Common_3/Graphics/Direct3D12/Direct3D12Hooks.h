...
extern "C"
{
    ...
    extern TinyImageFormat hook_get_recommended_swapchain_format(TFRenderer* pRenderer, const TFSwapChainDesc* pDesc,
                                                                 TFColorSpace colorSpace);
    ...
    extern void hook_copy_buffer_region(TFCmd* pCmd, ID3D12Resource* pDstBuffer, UINT64 DstOffset, ID3D12Resource* pSrcBuffer,
