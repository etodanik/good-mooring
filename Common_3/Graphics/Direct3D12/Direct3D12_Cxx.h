...
extern "C"
{
    ...
    typedef struct D3D12MA_ALLOCATION_DESC3
    {
...
typedef IDXGIAdapter4 D3D12MA_IDXGIAdapter;
    ...
    extern HRESULT D3D12MA_CreateResource3(struct D3D12MAAllocator_* pAllocator, const D3D12MA_ALLOCATION_DESC3* pDesc,
