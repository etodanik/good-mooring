...
#define PIPELINE_LAYOUT_DESC(pipelineDesc, none, perframe, perbatch, perdraw)                                                         \
    const TFDescriptorSetLayoutDesc* VARNAME(pipelineDesc)[4] = { none ? none : &gStaticSamplerLayout, perframe, perbatch, perdraw }; \
...
RS_STATIC_SAMPLER(SamplerState, gSamplerPointClamp, 0, 100, TF_FILTER_NEAREST, TF_MIPMAP_MODE_NEAREST, 1, TF_ADDRESS_MODE_CLAMP_TO_EDGE,
                  TF_ADDRESS_MODE_CLAMP_TO_EDGE, TF_ADDRESS_MODE_CLAMP_TO_EDGE, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerPointWrap, 1, 100, TF_FILTER_NEAREST, TF_MIPMAP_MODE_NEAREST, 1, TF_ADDRESS_MODE_REPEAT,
                  TF_ADDRESS_MODE_REPEAT, TF_ADDRESS_MODE_REPEAT, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerBilinearClamp, 2, 100, TF_FILTER_LINEAR, TF_MIPMAP_MODE_NEAREST, 1, TF_ADDRESS_MODE_CLAMP_TO_EDGE,
                  TF_ADDRESS_MODE_CLAMP_TO_EDGE, TF_ADDRESS_MODE_CLAMP_TO_EDGE, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerBilinearWrap, 3, 100, TF_FILTER_LINEAR, TF_MIPMAP_MODE_NEAREST, 1, TF_ADDRESS_MODE_REPEAT,
                  TF_ADDRESS_MODE_REPEAT, TF_ADDRESS_MODE_REPEAT, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerTrilinearClamp, 4, 100, TF_FILTER_LINEAR, TF_MIPMAP_MODE_LINEAR, 1, TF_ADDRESS_MODE_CLAMP_TO_EDGE,
                  TF_ADDRESS_MODE_CLAMP_TO_EDGE, TF_ADDRESS_MODE_CLAMP_TO_EDGE, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerTrilinearWrap, 5, 100, TF_FILTER_LINEAR, TF_MIPMAP_MODE_LINEAR, 1, TF_ADDRESS_MODE_REPEAT,
                  TF_ADDRESS_MODE_REPEAT, TF_ADDRESS_MODE_REPEAT, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerPointMirror, 6, 100, TF_FILTER_NEAREST, TF_MIPMAP_MODE_NEAREST, 1, TF_ADDRESS_MODE_MIRROR,
                  TF_ADDRESS_MODE_MIRROR, TF_ADDRESS_MODE_MIRROR, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerPointBorder, 7, 100, TF_FILTER_NEAREST, TF_MIPMAP_MODE_NEAREST, 1, TF_ADDRESS_MODE_CLAMP_TO_BORDER,
                  TF_ADDRESS_MODE_CLAMP_TO_BORDER, TF_ADDRESS_MODE_CLAMP_TO_BORDER, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerTrilinearMirror, 8, 100, TF_FILTER_LINEAR, TF_MIPMAP_MODE_LINEAR, 1, TF_ADDRESS_MODE_MIRROR,
                  TF_ADDRESS_MODE_MIRROR, TF_ADDRESS_MODE_MIRROR, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerTrilinearBorder, 9, 100, TF_FILTER_LINEAR, TF_MIPMAP_MODE_LINEAR, 1,
                  TF_ADDRESS_MODE_CLAMP_TO_BORDER, TF_ADDRESS_MODE_CLAMP_TO_BORDER, TF_ADDRESS_MODE_CLAMP_TO_BORDER, TF_CMP_NEVER)
RS_STATIC_SAMPLER(SamplerState, gSamplerAnisotropic, 10, 100, TF_FILTER_LINEAR, TF_MIPMAP_MODE_LINEAR, 8, TF_ADDRESS_MODE_REPEAT,
                  TF_ADDRESS_MODE_REPEAT, TF_ADDRESS_MODE_REPEAT, TF_CMP_NEVER)
