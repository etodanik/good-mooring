...
#define GPU_CONFIG_PROPERTY(name, token, ...)            \
    {                                                    \
        name, Read_##token, Write_##token, ##__VA_ARGS__ \
    }
#define GPU_CONFIG_PROPERTY_READ_ONLY(name, token, ...)  \
    {                                                    \
        name, Read_##token, Write_##token, ##__VA_ARGS__ \
    }
#define GPU_CONFIG_PROPERTY_GLOBAL(name, token, ...)     \
    {                                                    \
        name, Read_##token, Write_##token, ##__VA_ARGS__ \
    }
#define GPU_CONFIG_PROPERTY_READ_ONLY_GLOBAL(name, token, ...) \
    {                                                          \
        name, Read_##token, Write_##token, ##__VA_ARGS__       \
    }
