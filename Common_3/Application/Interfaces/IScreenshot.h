...
typedef struct TFScreenshotDesc
{
...
extern "C"
{
    ...
    FORGE_API void initScreenshotCapturer(TFRenderer* pRenderer, TFQueue* pGraphcisQueue, const char* appName);
    ...
    FORGE_API void captureScreenshot(TFScreenshotDesc* pDesc);
