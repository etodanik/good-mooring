...
public:
    ...
    virtual bool Init(TFRenderer* renderer, TFPipelineCache* pCache = NULL) = 0;
    virtual void Exit() = 0;
    ...
    virtual bool Load(TFRenderTarget** rts, uint32_t count = 1) = 0;
    virtual void Unload() = 0;

    virtual void Update(float deltaTime) = 0;
    virtual void Draw(TFCmd* cmd) = 0;
};