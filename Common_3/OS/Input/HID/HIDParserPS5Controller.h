...
static void HIDParsePS5CInputReport(PS5Controller* con, PS5CInputReport* currRep, TFInputPortIndex portIndex)
{
    UNREF_PARAM(con);
...
static void HIDParsePS5ControllerSimpleReport(PS5Controller* con, PS5CInputReportSimple* currRep, TFInputPortIndex portIndex)
{
    UNREF_PARAM(con);
