...
void openWindow(const char* app_name, TFWindowDesc* winDesc, id<MTLDevice> device)
{
...
void setFullscreen(TFWindowDesc* pWindow)
{
    // No-op
}
...
void getRecommendedResolution(TFRectDesc* rect) { *rect = TFRectDesc{ 0, 0, gDeviceWidth, gDeviceHeight }; }

void getRecommendedWindowRect(TFWindowDesc* winDesc, TFRectDesc* rect) { getRecommendedResolution(rect); }

void setResolution(const TFMonitorDesc* pMonitor, const TFResolution* pRes)
{
    // No-op
}
