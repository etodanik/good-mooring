...
static TFWindowDesc gCurrentWindow;
...
static TFReloadDesc gReloadDescriptor = { RELOAD_TYPE_ALL };
...
static TFThermalStatus gThermalStatus = TF_THERMAL_STATUS_NONE;
#if defined(ENABLE_FORGE_RELOAD_SHADER)
...
TFThermalStatus getThermalStatus(void) { return gThermalStatus; }
...
- (void)setThermalStatus:(NSProcessInfoThermalState)state
{
    TFThermalStatus newStatus = TF_THERMAL_STATUS_NOT_SUPPORTED;
    switch (state)
    {
    case NSProcessInfoThermalStateNominal:
        newStatus = TF_THERMAL_STATUS_LIGHT;
        break;
    case NSProcessInfoThermalStateFair:
        newStatus = TF_THERMAL_STATUS_MODERATE;
        break;
    case NSProcessInfoThermalStateSerious:
        newStatus = TF_THERMAL_STATUS_SEVERE;
        break;
    case NSProcessInfoThermalStateCritical:
        newStatus = TF_THERMAL_STATUS_CRITICAL;
        break;
    default:
        ASSERT(false);
    }
