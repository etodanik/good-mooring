...
static DarwinGamepad gDarwinGamepads[TF_MAX_GAMEPADS] = {};
static float         gRawMouseDelta[2] = {};
static TFMutex         gRumbleMutex = {};
...
// Gamepad
/************************************************************************/
static void GamepadUpdateState(TFInputPortIndex index)
{
...
/************************************************************************/
IOS14_API
static inline FORGE_CONSTEXPR TFInputEnum GetKey(GCKeyCode key)
{
...
static TFWindowDesc* pWindowRef = {};
#endif
/************************************************************************/
...
void platformInitInput(TFWindowDesc* winDesc)
{
    ...
    if (IOS14_RUNTIME)
    {
        ...
        // Mouse
        for (TFInputPortIndex c = 0; c < MAX_MICE; c++)
        {
            pMouseInputs[c] = nil;
        }
        ...
        [[NSNotificationCenter defaultCenter]
            addObserverForName:GCMouseDidConnectNotification
                    ...
                    usingBlock:^(NSNotification* note) {
                        ...
                        TFInputPortIndex portIndex = PORT_INDEX_INVALID;
                        for (TFInputPortIndex c = 0; c < MAX_MICE; c++)
                        {
        ...
        [[NSNotificationCenter defaultCenter]
            addObserverForName:GCControllerDidConnectNotification
                    ...
                    usingBlock:^(NSNotification* note) {
                        ...
                        ASSERT(controller);
                        TFInputPortIndex portIndex = PORT_INDEX_INVALID;
                        for (uint32_t c = 0; c < TF_MAX_GAMEPADS; ++c)
                        {
                        ...
                        static char controllerNames[TF_MAX_GAMEPADS][TF_FS_MAX_PATH] = {};
                        strncpy(controllerNames[portIndex], [controller.vendorName UTF8String], TF_FS_MAX_PATH);
