...
// DDS Loading
/************************************************************************/
static inline bool loadDDSTextureDesc(TFFileStream* pStream, TFTextureDesc* pOutDesc)
{
    ...
    TFTextureDesc& textureDesc = *pOutDesc;
    ...
    if (TinyDDS_IsCubemap(ctx))
    {
        ...
        textureDesc.mDescriptors |= TF_DESCRIPTOR_TYPE_TEXTURE_CUBE;
    }
...
// KTX Loading
/************************************************************************/
static inline bool loadKTXTextureDesc(TFFileStream* pStream, TFTextureDesc* pOutDesc)
{
    RETURN_IF_FAILED(pStream);
