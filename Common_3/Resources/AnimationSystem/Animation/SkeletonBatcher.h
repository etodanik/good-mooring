...
struct SkeletonRenderDesc
{
    ...
    TFBuffer*   mJointVertexBuffer;
    TFBuffer*   mBoneVertexBuffer;
    ...
    TFBufferCreationFlags mCreationFlag;
    bool                  mDrawBones;
...
public:
    ...
    void SetSharedUniforms(const TFCameraMatrix& projViewMat, const mat4& viewMat, const Vector3& lightPos, const Vector3& lightColor);
    ...
    void Draw(TFCmd* cmd, const uint32_t frameIndex);

    TFShader*   mJointShader = NULL;
    TFShader*   mBoneShader = NULL;
    TFPipeline* mJointPipeline = NULL;
    TFPipeline* mBonePipeline = NULL;
...
private:
    ...
    TFRenderer* mRenderer = NULL;
    TFBuffer*   mJointVertexBuffer = NULL;
    TFBuffer*   mBoneVertexBuffer = NULL;
    ...
    TFBuffer** mProjViewUniformBufferJoints = NULL;
    TFBuffer** mProjViewUniformBufferBones = NULL;
