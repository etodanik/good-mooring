...
public:
    ...
    void Initialize(const TFResourceDirectory resourceDir, const char* fileName, Rig* rig);
...
private:
    ...
    bool LoadClip(const TFResourceDirectory resourceDir, const char* fileName);
